...
//     }
//     try{
//       console.log('send order data:', { selectedAddress, paymentMethod ,totalPrice});
...
//     console.log('Order Confirmed:', { selectedAddress, paymentMethod ,totalPrice});
...
//                 <option value="">Select an address</option>
//                 {addresses.map((address)=>
//                 <option key={address.id} value={`${address.id}`}>{`${address.street}, ${address.city}, ${address.country}`}</option>
//                 )}
